...
if not ptracker_only:
    ...
    if not linux_only and not stracker_packager_only:
        ...
        assert 0 == os.system("pyinstaller --name stracker --clean -y --onefile --exclude-module http_templates --hidden-import cherrypy.wsgiserver.wsgiserver3 --hidden-import psycopg2 --hidden-import ptracker_lib.async_worker --hidden-import ptracker_lib.helpers --hidden-import ptracker_lib.dbgeneric --hidden-import ptracker_lib.dbapsw --hidden-import ptracker_lib.dbpostgres --hidden-import ptracker_lib.dbschemata --hidden-import ptracker_lib.config --hidden-import ptracker_lib.constants --hidden-import ptracker_lib.message_types --hidden-import ptracker_lib.ps_protocol --hidden-import ptracker_lib.ac_ini_files --hidden-import ptracker_lib.acsim --hidden-import ptracker_lib.expand_ac --hidden-import ptracker_lib.helithreading --hidden-import ptracker_lib.lap_collector --hidden-import ptracker_lib.read_ui_data --hidden-import ptracker_lib.DBGuidMapper --additional-hooks-dir=pyinstaller-hooks\ --path .. --path externals stracker.py")
