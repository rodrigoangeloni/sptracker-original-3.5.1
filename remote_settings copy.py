...
# Copy this file to remote_settings.py and configure your settings
...
host = "user@192.168.1.100"  # Replace with your WSL/remote host
...
REMOTE_BUILD_CMD = [
    ...
    f"cp -r /mnt/c/Users/YourUser/source/repos/sptracker-original-3.5.1/* {remote_path}/ && "
...
REMOTE_COPY_RESULT = [
    pscp,
    "-pw", password,
    f"{host}:/home/user/sptracker-build/stracker/stracker_linux_x86.tgz",
